...
<main class="flex flex-col flex-1 p-4">
    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Kevin</span> Kim
                <br />Full Stack
    ...
    <section class="py-20 lg:py-32 flex flex-col gap-24" id="projects">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
            <Step step={steps[0]}>
                <p>
                    My React Portfolio is<strong
                        class="text-violet-400"
                        >Next.js, React.js, Three.js & TailwindCSS!</strong
                    > It contains 3D graphics of my desktop setting.
                </p>
            </Step>
            <Step step={steps[1]}>
                <p>
                    Animation List is a <strong
                        class="text-violet-400">Next.js</strong
                    >,
                    <strong class="text-violet-400">+ Framer Motion</strong
                    >
                    web application that allows a user to view infinite lists of animations fetched from API.
                </p>
            </Step>
            <Step step={steps[2]}>
                <p>
                    Personal Blog is a full stack<strong class="text-violet-400"
                        >Next.js & TailwindCSS & GraphQL</strong
                    >
                    CRUD application, hosted on
                    <strong class="text-violet-400">Netlify</strong>, that
                    consumes and caches the
                    <strong class="text-violet-400">blog</strong>
                    to display all data on database!
                </p>
            </Step>
        </div>
    </section>
