...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        ...
        <p><b class="pr-2">Email</b> kdkim7676@gmail.com</p>
        <p>
            <b class="pr-2">GitHub</b>
            <a href="https://github.com/dohyungkk" target="_blank" class="text-violet-400"
                >github/dohyungkk<sup class=""
        ...
        <p>
            ...
            <a href="https://www.linkedin.com/in/kevin-kim-279645155/" target="_blank" class="text-violet-400"
                >linkedin/kevin-kim-279645155<sup class="">
                    <span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
                        /></span
